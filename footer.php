			...
			<div class="footer-gray">
				<div class="footer-custom">
					<div class="footer-lists">
							...
							<ul class="ftr-links-sub">
								...
								<li
									><a href="/catalog" rel="nofollow"
										><strong>Shop Our Catalog</strong></a
									></li
								>
								<li
						...
						<div class="footer-list-wrap">
							...
							<ul class="ftr-links-sub">
								...
								<art:content rule="loggedin">
									<li class="ftr-Login"
										><span class="link ftr-access-my-account"
											>Access My Account</span
										></li
									>
									<li
					...
					<div class="footer-email">
						<h6 class="ftr-hdr"
							>Sign up for exclusive offers and inspiration</h6
						>
                ...
                -->
					...
					<div class="footer-legal">
						<p
							...
							>
							|
							<a href="/help/terms-of-use.html" rel="nofollow">Terms of Use</a>
							|
						...
						<p
							...
							registered trademarks of Art.com Inc.</p
						>
						<p
							>Various aspects of this website are covered by issued US patent
							No. 7,973,796 and other pending patent applications.</p
						>
					</div>
					<!--/.footer-legal-->
